...
orphan slot, recovering the L1 mutez. The drained slot produces a
duplicate recipient commitment at a new tree position; the two leaves
are publicly correlatable to the same intent but each gets a distinct
nullifier and is independently spendable.
