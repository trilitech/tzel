...
fn main() -> Array<felt252> {
    ...
    transfer::verify(
        root,
        hash::nullifier(c.nsk, c.rho),
        hash::nullifier(z.nsk, z.rho),
        d.cm, e.cm,
        c.nsk, c.ak, c.v, c.rho, c.r, sib_c.span(), idx_c,
        z.nsk, z.ak, z.v, z.rho, z.r, sib_z.span(), idx_z,
        d.pk, d.ak, d.v, d.rho, d.r,
        e.pk, e.ak, e.v, e.rho, e.r,
    )
}
